...
class BurakoGameRepository
{
     ...
     *
     * @param  int  $gameId  Identifier of the game.
     * @return \App\Data\GameSummaryData Raw query results for the game, its teams, players, and rounds.
     * Logic: execute three focused DB queries — game_team JOIN teams, team_player JOIN players LEFT JOIN
     *   seats, and round_scores JOIN rounds JOIN teams — and wrap them in a GameSummaryData value object.
     *   All assembly and domain logic is delegated to GameSummaryResource and RoundRoleCalculator.
     */
